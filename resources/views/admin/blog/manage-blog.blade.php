                    ...
                    <table class="data-tables table mb-0 tbl-server-info">
                        ...
                        <tbody class="ligth-body">
                            ...
                            <tr>
                                <td>{{$blog->idBlog}}</td>
                                <td>
                                    <img src="{{asset('public/storage/kiddash/images/blog/'.$blog->BlogImage)}}" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    {{$blog->BlogTitle}}
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sửa" href="{{URL::to('/edit-blog/'.$blog->idBlog)}}"><i class="ri-pencil-line mr-0"></i></a>

                                        <a class="badge bg-warning mr-2" data-toggle="modal" data-target="#modal-delete-{{$blog->idBlog}}" data-placement="top" title="" data-original-title="Xóa" style="cursor:pointer;"><i class="ri-delete-bin-line mr-0"></i></a>
                                    </div>
                                </td>
                            </tr>
