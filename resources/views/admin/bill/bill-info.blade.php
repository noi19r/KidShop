                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="row" style="border-bottom:0;">
                                                    ...
                                                    <img class="avatar-70 rounded" src="{{asset('public/storage/kiddash/images/product/'.$image)}}" alt="">
                            ...
                            <div class="col-lg-12">
                                <div class="or-detail rounded">
                                    <div class="p-3 row">
                                        ...
                                        @if($Total < 1000000) @php $ship='30000' ; $total_bill=$Total + $ship; @endphp @else @php $ship='Miễn phí' ; $total_bill=$Total; @endphp @endif <div class="mb-2 col-lg-10">
                                    ...
                                    if($total_bill < 0) $total_bill=$ship; @endphp <div class="mb-2 col-lg-2 text-right">
