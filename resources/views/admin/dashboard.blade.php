                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-info-light">
                                        <img src="public/kiddash/images/product/1.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-success-light">
                                        <img src="public/kiddash/images/product/3.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <form class="col-lg-6 p-0"> @csrf
                            <div class="row">
                                ...
                                <button type="button" class="badge badge-info p-0 statistic-btn" style="border:none; width:7%; margin-left:12px; font-size:20px;" data-toggle="tooltip" data-placement="top" title="" data-original-title="Tìm kiếm"><i class="ri-search-line"></i>
                                </button>
                            </div>
                        </form>
                                ...
                                <div class="card card-block card-stretch mb-0">
                                    <div class="card-body">
                                        <div class="bg-warning-light rounded">
                                            ...
                                            <img src="{{asset('public/storage/kiddash/images/product/'.$image)}}" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                    ...
                    <div class="card-body--AllTime card-item-right">
                        <div class="d-flex align-items-top">
                            <div class="iq-avatar d-flex align-items-center">
                                ...
                                <img src="{{asset('public/storage/kiddash/images/product/'.$image)}}" class="p-0 avatar-100 style-img img-fluid m-auto rounded" alt="image">
                            </div>
