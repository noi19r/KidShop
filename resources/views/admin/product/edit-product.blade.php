                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex flex-wrap" id="image-list">
                                            ...
                                            <div id="image-item-{{$key}}" class="image-item">
                                                <img src="{{asset('public/storage/kiddash/images/product/'.$image)}}" class="img-fluid rounded avatar-100 mr-3 mt-2">
                    ...
                    <div class="popup text-left">
                        ...
                        <div class="content create-workform bg-body">
                            ...
                            <div class="pb-3 d-flex flex-wrap" id="attribute_value">
                                @foreach($list_pd_attr as $key => $pd_attr)
                                <label for="chk-attr-{{$pd_attr->idAttrValue}}" class="d-block col-lg-3 p-0 m-0">
                                    <div id="attr-name-{{$pd_attr->idAttrValue}}" class="select-attr text-center mr-2 mt-2 border-primary text-primary">{{$pd_attr->AttrValName}}</div>
                                </label>
