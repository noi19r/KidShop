                                ...
                                <td>
                                    <form> @csrf
                                        <div class="d-flex align-items-center list-action">
                                            ...
                                            <button type="button" class="badge badge-dark mr-2 btn-StatusPro" data-toggle="tooltip" data-placement="top" title="" data-original-title="Hiện" style="border:none;" data-id="{{$product->idProduct}}" data-statuspro="1"><i class="fa fa-eye-slash"></i></i></button>
                                            @else
                                            <button type="button" class="badge badge-primary mr-2 btn-StatusPro" data-toggle="tooltip" data-placement="top" title="" data-original-title="Ẩn" style="border:none;" data-id="{{$product->idProduct}}" data-statuspro="0"><i class="fa fa-eye"></i></i></button>
                                            @endif
                                            <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sửa" href="{{URL::to('/edit-product/'.$product->idProduct)}}"><i class="ri-pencil-line mr-0"></i></a>
                                            <a class="badge bg-warning mr-2" data-toggle="modal" data-tooltip="tooltip" data-target="#modal-delete-{{$product->idProduct}}" data-placement="top" title="Xóa" data-original-title="Xóa" style="cursor:pointer;"><i class="ri-delete-bin-line mr-0"></i></a>
                                        </div>
                                    </form>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-StatusPro').on('click', function() {
            ...
            $.ajax({
                url: '/change-status-product/' + idProduct,
                method: 'POST',
                data: {
                    StatusPro: StatusPro,
                    _token: _token
