                ...
                <div class="modal-body row">
                    ...
                    <div class="product-item col-md-3 select-pd" id="product-item-{{$product->idProduct}}" data-id="{{$product->idProduct}}">
                        <div class="product-image mb-3" id="product-image-{{$product->idProduct}}">
                            ...
                            <label for="chk-pd-{{$product->idProduct}}"><img src="{{asset('public/storage/kiddash/images/product/'.$image)}}" class="rounded w-100 img-fluid" /></label>
                ...
                $(document).ready(function() {
                    $("#confirm").click(function() {
                        if ($(".list-product > #product-list-item-" + product_id).length < 1)
                            $(".list-product").append('<div class="product-item col-md-2" id=product-list-item-' + product_id + '><div class="product-image" id=product-list-image-' + product_id + '><img src="public/storage/kiddash/images/product/' + product_img + '" class="rounded w-100 img-fluid"><div class="product-title"><div class="product-name"><span>' + product_name + '</span></div></div></div></div>');
                    })
                })
