                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="product-item">
                            ...
                            <td class="image">
                                <a href="{{URL::to('/shop-single/'.$pd_cart->ProductSlug)}}"><img src="{{asset('public/storage/kiddash/images/product/'.$image)}}" alt=""></a>
                            </td>
                            <td class="product">
