...
<div class="slider-area">
    <div class="swiper-container slider-active">
        <div class="swiper-wrapper">
            <!--Single Slider Start-->
            <div class="single-slider swiper-slide animation-style-01" style="background-image: url('public/kidshop/images/slider/KIDOLBanner.png');">
                <div class="container">
            ...
            <!--Single Slider Start-->
            <div class="single-slider swiper-slide animation-style-01" style="background-image: url('public/kidshop/images/slider/KIDOLBanner2.png');">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="single-shipping">
                    <div class="shipping-icon">
                        <img src="public/kidshop/images/shipping-icon/Free-Delivery.png" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-shipping">
                    <div class="shipping-icon">
                        <img src="public/kidshop/images/shipping-icon/Online-Order.png" alt="">
                    </div>
                    <div class="shipping-content">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-shipping">
                    <div class="shipping-icon">
                        <img src="public/kidshop/images/shipping-icon/Freshness.png" alt="">
                    </div>
                    <div class="shipping-content">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-shipping">
                    <div class="shipping-icon">
                        <img src="public/kidshop/images/shipping-icon/Made-By-Artists.png" alt="">
                    </div>
                    <div class="shipping-content">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-image">
                    <img src="public/kidshop/images/banner/banner_home.png" alt="">
                </div>
            </div>
            <div class="col-lg-6">
...
<!--Testimonial Start-->
<!-- <div class="testimonial-area" style="background-image: url(public/kidshop/images/testimonial-bg.jpg);">
    <div class="container">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-author">
                            <img src="public/kidshop/images/testimonial-img-1.png" alt="">
                ...
                <div class="swiper-slide">
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-author">
                            <img src="public/kidshop/images/testimonial-img-2.png" alt="">
        ...
        <div class="expert-wrapper">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-expert text-center">
                        <div class="expert-image">
                            <img src="public/kidshop/images/experts/team-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-expert text-center">
                        <div class="expert-image">
                            <img src="public/kidshop/images/experts/team-2.jpg" alt="">
                        </div>
                        <div class="expert-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-expert text-center">
                        <div class="expert-image">
                            <img src="public/kidshop/images/experts/team-3.jpg" alt="">
                        </div>
                        <div class="expert-content">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-expert text-center">
                        <div class="expert-image">
                            <img src="public/kidshop/images/experts/team-4.jpg" alt="">
                        </div>
                        <div class="expert-content">
