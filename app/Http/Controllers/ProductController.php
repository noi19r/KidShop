    ...
    public function submit_add_product(Request $request)
    {
        ...
        if ($select_product) {
            ...
            foreach ($get_image as $image) {
                ...
                $image->storeAs('public/kiddash/images/product', $new_image);
                $images[] = $new_image;
            }
        ...
        if ($select_product) {
            ...
            if ($request->file('ImageName')) {
                ...
                foreach (json_decode($get_old_mg->ImageName) as $old_img) {
                    Storage::delete('public/kiddash/images/product/' . $old_img);
                }
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="quick-view-image">
                                                <img src="public/storage/kiddash/images/product/' . $image . '" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
        ...
        foreach ($get_pd as $key => $pd) {
            ...
            $output .= '    <div class="product-item col-md-3 select-pd" id="product-item-' . $pd->idProduct . '" data-id="' . $pd->idProduct . '">
                                <div class="product-image-compare mb-3" id="product-image-' . $pd->idProduct . '">
                                    <label for="chk-pd-' . $pd->idProduct . '"><img src="public/storage/kiddash/images/product/' . $image . '" class="rounded w-100 img-fluid"></label>       
            ...
            foreach ($get_pd as $pd) {
                ...
                $output .= '
                    <li class="search-product-item d-flex align-items-center">
                        <a class="search-product-text" href="/../kidshop/shop-single/' . $pd->ProductSlug . '">
                            <div class="d-flex align-items-center">
                                <img width="50" height="50" src="/../kidshop/public/storage/kiddash/images/product/' . $image . '" alt="">
